...
## 📊 Data Scientist | 💼 Investment Specialist | 🧬 Health Background

Sou um profissional multidisciplinar em transição para a área de tecnologia, unindo a expertise do **Mercado Financeiro**, o rigor da **Engenharia Biomédica** e a visão analítica da **Ciência de Dados**. 

Atualmente, curso **Sistemas de Informação (FeMASS)** e finalizo minha especialização em **Data Science (FIAP)**, focando em transformar dados brutos em decisões estratégicas de alto impacto para stackholders

---

### 🚀 O que eu trago para a mesa:
* **Business Intelligence & Finance:** Ex-Assessor de Investimentos (**Banco Safra / XP**) com aprovações em certificações **CPA-20** e **ANCORD**. Expertise em prospecção de empresas, desenvolvimento de novos negócios e análise de risco para investimentos.
* **Domínio em Healthcare:** Formação em Fisioterapia com passagem pelo Mestrado em **Engenharia Biomédica (UFRJ)**. Compreensão profunda de dados clínicos e sinais biológicos.
* **Data Science na Prática:**  estudos de casos reais desenvolvidos, focados em soluções de ponta a ponta, do tratamento de dados à visualização.

---

### 🛠️ Hard Skills & Certificações
| Categoria | Competências |
| :--- | :--- |
| **Tecnologia** | Python (Pandas, Scikit-Learn, NumPy), SQL, Sistemas de Informação |
| **Finanças** | ANBIMA CPA-20, ANCORD (Agente Autônomo de Investimentos) |
| **Data Viz** | Matplotlib, Seaborn |
| **Negócios** | Business Development, Gestão de Portfólio, Análise de Mercado |

---

### 📂 Projetos de Ciência de Dados
> Projetos que conectam dados a resultados reais:

1.  **[Nome do Projeto 1]**: (Ex: Modelo preditivo aplicado ao setor financeiro ou saúde).
2.  **[Nome do Projeto 2]**: (Ex: Análise exploratória de dados e automação de processos).
3.  **[Nome do Projeto 3]**: (Ex: Dashboard estratégico para tomada de decisão).

---

### 🎓 Trajetória Acadêmica & Profissional
* **Sistemas de Informação** – FeMASS (Graduando)
* **Ciência de Dados** – [FIAP] (Pós-graduação)
* **Experiência Profissional** – Banco Safra e XP (Business Development / Investimentos)
* **Engenharia Biomédica** – UFRJ (Participação em Mestrado)
* **Fisioterapia** – [UNESA] (Graduação)

---

### 📫 Vamos conectar e gerar valor?
